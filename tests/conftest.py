...
# --------------------------------------
# Fixture: Load reference data for benchmarking
# --------------------------------------
@pytest.fixture(scope="session")
def reference_fig2():
    """Load reference time data for Figure 2."""
    tmm_path = os.path.join(os.path.dirname(__file__), "layer_count_exp_time_of_tmm.npy")
    time_tmm = np.load(tmm_path)
    vtmm_path = os.path.join(os.path.dirname(__file__), "layer_count_exp_time_of_vtmm.npy")
    time_vtmm = np.load(vtmm_path)
    tmm_fast_path = os.path.join(os.path.dirname(__file__), "layer_count_exp_time_of_tmm_fast.npy")
    time_tmm_fast = np.load(tmm_fast_path)
    tmmax_path = os.path.join(os.path.dirname(__file__), "layer_count_exp_time_of_tmmax.npy")
    time_tmmax = np.load(tmmax_path)
    return time_tmm, time_vtmm, time_tmm_fast, time_tmmax

@pytest.fixture(scope="session")
def reference_fig3_8_layer():
    """Load reference time data for Figure 3."""
    tmm_path = os.path.join(os.path.dirname(__file__), "time_of_tmm_wl_theta_arr_8_layer.npy")
    time_tmm = np.load(tmm_path)
    vtmm_path = os.path.join(os.path.dirname(__file__), "time_of_vtmm_wl_theta_arr_8_layer.npy")
    time_vtmm = np.load(vtmm_path)
    tmm_fast_path = os.path.join(os.path.dirname(__file__), "time_of_tmm_fast_wl_theta_arr_8_layer.npy")
    time_tmm_fast = np.load(tmm_fast_path)
    tmmax_path = os.path.join(os.path.dirname(__file__), "time_of_tmmax_wl_theta_arr_8_layer.npy")
    time_tmmax = np.load(tmmax_path)
    return time_tmm, time_vtmm, time_tmm_fast, time_tmmax

@pytest.fixture(scope="session")
def reference_fig3_80_layer():
    """Load reference time data for Figure 3."""
    tmm_path = os.path.join(os.path.dirname(__file__), "time_of_tmm_wl_theta_arr_80_layer.npy")
    time_tmm = np.load(tmm_path)
    vtmm_path = os.path.join(os.path.dirname(__file__), "time_of_vtmm_wl_theta_arr_80_layer.npy")
    time_vtmm = np.load(vtmm_path)
    tmm_fast_path = os.path.join(os.path.dirname(__file__), "time_of_tmm_fast_wl_theta_arr_80_layer.npy")
    time_tmm_fast = np.load(tmm_fast_path)
    tmmax_path = os.path.join(os.path.dirname(__file__), "time_of_tmmax_wl_theta_arr_80_layer.npy")
    time_tmmax = np.load(tmmax_path)
    return time_tmm, time_vtmm, time_tmm_fast, time_tmmax